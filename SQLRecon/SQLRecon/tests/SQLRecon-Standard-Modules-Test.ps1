...
Execute "$sqlreconPath /enum:info /port:1434 /timeout:1 /host:172.16.40.101,$server2"
...
Execute "$sqlreconPath /auth:$authentication /host:$server2 /m:columns /db:AdventureWorks /table:Product"
Execute "$sqlreconPath /auth:$authentication /host:$server2 /m:query /database:AdventureWorks /c:'SELECT TOP (5) *  FROM SalesLT.Product'"
Execute "$sqlreconPath /auth:$authentication /host:$server1 /m:rows /db:AdventureWorks /table:SalesLT.Product"
Execute "$sqlreconPath /auth:$authentication /host:$server2 /m:search /db:AdventureWorks /keyword:Product"
Execute "$sqlreconPath /auth:$authentication /host:$server3 /m:smb /unc:\\172.16.40.110\test"
...
Write-Output ""
Execute "$sqlreconPath /auth:$authentication /host:$server1 /m:disablerpc /rhost:$server1"
...
Execute "$sqlreconPath /auth:$authentication /host:$server1 /m:enablerpc /rhost:$server1"
...
Execute "$sqlreconPath /auth:$authentication /host:$server2 /m:olecmd /c:'c:\temp\mb-standard-2.exe'"
