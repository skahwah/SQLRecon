...
namespace SQLRecon.Modules
{
    public class Help
    {
        ...
        {
            Console.WriteLine("SQLRecon.exe");
            Console.WriteLine("");

            Console.WriteLine("Examples");
            Console.WriteLine("\tSQLRecon.exe --Auth Windows --SQLServer SQL01 --Database Master -m mapped");
            Console.WriteLine("\tSQLRecon.exe --Auth Local --SQLServer SQL02 --Database Master --Username sa --Password Password123 -m query -q \"SELECT @@VERSION;\"");
            Console.WriteLine("\tSQLRecon.exe --Auth Local --SQLServer SQL01 --Database Master --Username map --Password Password123 -m ienableole -i sa");
            Console.WriteLine("\tSQLRecon.exe --Auth Local --SQLServer SQL01 --Database Master --Username sa --Password Password123 -m lquery -l SQL02 -q \"SELECT @@VERSION;\"");
            Console.WriteLine("");
            ...
            Console.WriteLine("\t[+] lquery -l LINKEDSERVERNAME -o QUERY - Execute an arbitary SQL query on a linked SQL server");
            Console.WriteLine("\t[+] ldatabases -l LINKEDSERVERNAME - Show all databases present on the Linked SQL server");
            Console.WriteLine("\t[+] ltables -l LINKEDSERVERNAME - Show all tables in the database you are connected to on the Linked SQL server");
            Console.WriteLine("");
